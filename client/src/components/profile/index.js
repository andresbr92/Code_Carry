                                ...
                                <Accordion defaultActiveKey="1">
                                    <Card>
                                        ...
                                        <Accordion.Collapse eventKey="0">
                                            <Card.Body>  <h4>{this.state.user[1].map((elm) => <><Link key={elm._id} to={`/question/details/${elm._id}`}><p>titulo :{elm.title} </p></Link><Button onClick={()=>this.removeQuestionProfile(elm._id)}>ELiminar</Button></>)}</h4> </Card.Body>
                                        </Accordion.Collapse>
                                    </Card>
                                </Accordion>
                                <hr></hr>
